...
def package_results(vars_system: dict, params_system:dict, output_path: Path) -> dict:
    """
    Convert optimization variables to dictionary and save to file if needed.
    """
    import json
...
def get_summary_results(dict_results, params_system, objective_value, output_path=None):
    ...
    from src.safepaw_opt.core.utils.data_utils_Burdett import get_patients_blocking
    import pandas as pd
    import json
